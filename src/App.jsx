...
<form onSubmit={handleSubmit} className='rounded-lg bg-white p-12 w-[46rem] flex flex-col gap-6'>
  ...
  <div className="flex flex-col md:flex-row gap-4">
    <div className="w-full md:w-[50%]">
      ...
      <input value={firstName} onChange={(e) => setFirstName(e.target.value)}
        ...
        type="text" id="first-name" name="firstName" autoComplete="given-name" aria-label="Enter your first name" />
    ...
    <div className="w-full md:w-[50%]">
      ...
      <input value={lastName} onChange={(e) => setLastName(e.target.value)}
        className="cursor-pointer rounded-lg border border-[var(--Grey-900-darker)] w-full p-2 mt-2 focus:border-[var(--Green-600-medium)] focus:outline-none focus:ring-1 focus:ring-[var(--Green-600-medium)]"
        type="text" id="last-name" name="lastName" autoComplete="family-name" aria-label="Enter your last name" />
  ...
  <div className="w-[100%]">
    ...
    <input value={email} onChange={(e) => setEmail(e.target.value)}
      className="cursor-pointer rounded-lg border border-[var(--Grey-900-darker)] w-full p-2 mt-2 focus:border-[var(--Green-600-medium)] focus:outline-none focus:ring-1 focus:ring-[var(--Green-600-medium)]"
      type="text" id="email" name="email" autoComplete="email" aria-label="Enter your email address" />
  ...
  <div>
    ...
    <textarea value={message} onChange={(e) => setMessage(e.target.value)}
      className="cursor-pointer rounded-lg border border-[var(--Grey-900-darker)] w-full p-2 mt-2 focus:border-[var(--Green-600-medium)] focus:outline-none focus:ring-1 focus:ring-[var(--Green-600-medium)]"
      id="message" name="message" rows="4" cols="50" aria-label="Enter your message"></textarea>
  ...
  <div>
    <div className="flex items-center gap-2">
      ...
      <label htmlFor="custom-checkbox" className="flex items-center gap-2 cursor-pointer" aria-label="Consent to being contacted">
        <span className="w-3 h-3 flex items-center justify-center border border-[var(--Grey-900-darker)] peer-checked:border-[var(--Green-600-medium)] peer-focus:outline peer-focus:outline-1 peer-focus:outline-[var(--Green-600-medium)]">
